<x-guest-layout>
<div class="w-screen bg-gradient-to-b from-sky-100 to-sky-300">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 lg:mt-12">
        <div class="mt-6 p-12 bg-sky-300 text-gray-600 dark:text-gray-400 text-base rounded-lg shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12 text-center">
                ...
                <form method="GET" action="{{ route('teacher_create') }}" enctype="multipart/form-data">
                  @csrf
