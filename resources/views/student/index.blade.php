<x-guest-layout>
<div class="w-screen bg-gradient-to-b from-purple-100 to-purple-300">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 lg:mt-12">
        <div class="mt-6 p-12 bg-purple-300 text-gray-600 dark:text-gray-400 text-base rounded-lg shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12 text-center">
                ...
                <a href="{{ route('student_gender') }}">
                  <button type="button" class="w-full ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-lg font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                    Yes, I agree.
                  </button>
                </a>
