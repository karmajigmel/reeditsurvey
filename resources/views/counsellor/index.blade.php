<x-guest-layout>
<div class="w-screen bg-gradient-to-b from-amber-100 to-amber-300">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 lg:mt-12">
        <div class="mt-6 p-12 bg-amber-300 text-gray-600 dark:text-gray-400 text-base rounded-lg shadow-sm">
            <h1 class="text-4xl font-bold mb-8 text-gray-700 text-center">
                Counsellor/Focal Teacher
            </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-12 text-center">
                ...
                <form method="GET" action="{{ route('counsellor_create') }}" enctype="multipart/form-data">
                  @csrf
